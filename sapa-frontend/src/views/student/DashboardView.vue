...
<template>
  ...
  >
    ...
    >
      ...
      >
        ...
        <div class="flex shrink-0 items-center gap-2 sm:gap-3">
          ...
          >
            <div
              class="flex h-9 w-9 items-center justify-center overflow-hidden rounded-full border border-emerald-500/30 bg-emerald-500/10 text-[11px] font-bold text-emerald-400 transition-all duration-200 group-hover:border-emerald-500/60 group-hover:bg-emerald-500/20"
            >
              <img
                v-if="avatarUrl"
                :src="avatarUrl"
    ...
    >
          ...
          >
            ...
            >
              ...
              >
                <!-- Avatar Container -->
                <div
                  class="relative flex h-12 w-12 shrink-0 items-center justify-center rounded-full border border-emerald-500/30 bg-emerald-500/10 text-sm font-bold text-emerald-400 transition-all duration-200 group-hover:border-emerald-500/60 group-hover:bg-emerald-500/20"
                >
                  <!-- Gambar Profil (dengan wrapper overflow-hidden internal) -->
                  <div
                    class="h-full w-full overflow-hidden rounded-full flex items-center justify-center"
                  >
                    <img
                      v-if="avatarUrl"
                      :src="avatarUrl"
      ...
      <section class="fade-up space-y-4" style="animation-delay: 90ms">
        ...
        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
          ...
          >
            <span
              class="absolute left-0 top-5 bottom-5 w-0.75 rounded-r-full bg-purple-500/70"
              aria-hidden="true"
            ></span>
            <div class="flex items-start justify-between gap-3">
              <div
                class="flex h-11 w-11 items-center justify-center rounded-lg border border-purple-500/25 bg-purple-500/10 text-purple-400 transition-all duration-200 group-hover:scale-110 group-hover:border-purple-500/40"
              >
          ...
          >
            <span
              class="absolute left-0 top-5 bottom-5 w-0.75 rounded-r-full bg-cyan-500/70"
              aria-hidden="true"
            ></span>
            <div class="flex items-start justify-between gap-3">
              <div
                class="flex h-11 w-11 items-center justify-center rounded-lg border border-cyan-500/25 bg-cyan-500/10 text-cyan-400 transition-all duration-200 group-hover:scale-110 group-hover:border-cyan-500/40"
              >
          ...
          >
            <span
              class="absolute left-0 top-5 bottom-5 w-0.75 rounded-r-full bg-rose-500/70"
              aria-hidden="true"
            ></span>
            <div class="flex items-start justify-between gap-3">
              <div
                class="flex h-11 w-11 items-center justify-center rounded-lg border border-rose-500/25 bg-rose-500/10 text-rose-400 transition-all duration-200 group-hover:scale-110 group-hover:border-rose-500/40"
              >
            ...
            <div
              class="mt-4 flex items-center gap-2 border-t border-slate-800/70 pt-3"
            >
      ...
      <section class="fade-up" style="animation-delay: 270ms">
        ...
        >
          ...
          <div
            class="hidden border-b border-slate-800/70 bg-slate-950/50 px-5 py-2.5 lg:grid lg:grid-cols-[minmax(0,1fr)_120px_112px_104px_96px] lg:gap-x-4 sm:px-6"
          >
            <p
              class="text-[10px] font-semibold uppercase tracking-[0.14em] text-slate-600"
            >
    ...
    <footer class="border-t border-slate-800/70">
      <div
        class="mx-auto flex max-w-7xl flex-col items-center justify-between gap-3 px-4 py-6 sm:flex-row sm:px-6 lg:px-8"
      >
