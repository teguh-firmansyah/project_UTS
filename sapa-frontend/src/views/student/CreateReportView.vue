  ...
  <div class="sapa-root flex min-h-screen flex-col bg-slate-950 font-sans text-slate-100 antialiased selection:bg-emerald-500/25">
    ...
    <main class="mx-auto w-full max-w-7xl flex-1 px-4 py-8 sm:px-6 lg:px-8 lg:py-10">
      ...
      <div class="mt-8 grid items-start gap-6 lg:grid-cols-[minmax(0,1fr)_320px]">
        ...
        >
          <span class="absolute inset-x-0 top-0 h-0.5 bg-linear-to-r transition-colors duration-300" :class="activeStyle.topBar" aria-hidden="true"></span>
          ...
          <section class="space-y-3.5">
            ...
            <div v-if="selectedCategory === 'bullying'" class="note-enter flex items-start gap-2.5 rounded-lg border border-rose-500/25 bg-rose-500/5 px-3.5 py-3">
              <ShieldAlert class="mt-0.5 h-4 w-4 shrink-0 text-rose-400/90" />
            ...
            <div v-if="selectedCategory === 'fasilitas'" class="space-y-3.5">
              ...
              <div class="grid grid-cols-1 gap-3 sm:grid-cols-2">
                <div class="space-y-1.5">
                  ...
                  <div class="relative">
                    <Sliders class="pointer-events-none absolute left-3.5 top-1/2 h-4 w-4 -translate-y-1/2 text-slate-500" />
                    <select
                ...
                <div class="space-y-1.5">
                  ...
                  <div class="relative">
                    <AlertTriangle class="pointer-events-none absolute left-3.5 top-1/2 h-4 w-4 -translate-y-1/2 text-slate-500" />
                    <select
                      v-model="damageLevel"
                ...
                <div class="grid grid-cols-1 gap-3 sm:grid-cols-2">
                  <label
                    ...
                    :class="reporterRelation === 'victim' 
                      ? 'border-rose-500/50 bg-rose-500/6 ring-1 ring-rose-500/30' 
          ...
          <section v-if="selectedCategory !== 'aspirasi'" class="space-y-3.5 border-t border-slate-800/70 pt-6">
            ...
            <label
              ...
              :class="isDragging ? 'border-emerald-500/70 bg-emerald-500/6' : 'border-slate-700/80 bg-slate-950/40 hover:border-emerald-500/50 hover:bg-slate-950/70'"
            ...
            <div v-if="imagePreviews.length" class="space-y-2.5">
              ...
              >
                ...
                <div v-else class="flex h-16 w-16 shrink-0 items-center justify-center rounded-lg border border-slate-800 bg-slate-900 text-[10px] font-semibold text-slate-500">PDF</div>
          ...
          <section class="space-y-3.5 border-t border-slate-800/70 pt-6">
            ...
            <label
              ...
              :class="is_anonymous ? 'border-emerald-500/30 bg-emerald-500/5' : 'border-slate-800 bg-slate-950/40 hover:border-slate-700'"
            >
              ...
              >
                <EyeOff v-if="is_anonymous" class="h-4 w-4" />
        ...
        <aside class="space-y-5 lg:sticky lg:top-20">
          <div class="fade-up rounded-xl border border-slate-800 bg-slate-900 p-5" style="animation-delay: 150ms">
            ...
            <ul class="mt-4 space-y-3">
              <li v-for="(tip, i) in activeGuide.tips" :key="i" class="flex gap-2.5">
                <Check class="mt-0.5 h-3.5 w-3.5 shrink-0" :class="activeStyle.guideIcon" />
                <p class="text-[11px] leading-relaxed text-slate-400">{{ tip }}</p>
              </li>
            </ul>
          </div>

          <div v-if="selectedCategory === 'bullying'" class="note-enter flex items-start gap-3 rounded-xl border border-amber-500/25 bg-amber-500/5 p-4">
          ...
          <div class="fade-up rounded-xl border border-slate-800 bg-slate-900 p-5" style="animation-delay: 200ms">
            ...
            <ol class="mt-4 space-y-3">
              <li v-for="step in followUpSteps" :key="step.label" class="flex items-center gap-2.5">
            ...
            <p class="mt-4 flex items-start gap-1.5 border-t border-slate-800/70 pt-3 text-[11px] leading-relaxed text-slate-600">
              <Lock class="mt-0.5 h-3.5 w-3.5 shrink-0 text-emerald-500/70" />
